...
(defn route53 [suffix] (str "AWS::Route53::" suffix))

;; recordset https://docs.aws.amazon.com/AWSCloudFormation/latest/UserGuide/aws-properties-route53-recordset.html

;; alias-target (TODO to namespace or not to namespace, pending discussion)
...
(defresource record-set (route53 "RecordSet") ::record-set)
